  ...
  return (
    <Link href="/" className={cn("flex items-center gap-2.5", className)}>
      <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-teal-600">
        <svg viewBox="0 0 80 80" className="h-5 w-5">
          <path d="M20 48 L30 58 L55 28" fill="none" stroke="white" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
      </div>
      <div className="leading-tight">
        <div className="text-xl font-bold text-gray-900 dark:text-white">Chayan</div>
        <div className="text-[10px] font-medium tracking-wider text-gray-500 dark:text-gray-400 -mt-0.5">select right. serve right.</div>
      </div>
    </Link>
  )
}
