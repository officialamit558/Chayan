            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="mailto:contact@chayan.in" className="text-sm text-blue-600 hover:underline">
                    contact@chayan.in
                  </a>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="tel:+911123456789" className="text-sm text-blue-600 hover:underline">
                    +91-11-23456789
                  </a>
        ...
        <div>
          <section className="rounded-lg border bg-white p-6">
            ...
            <p className="mb-6 text-sm text-gray-600">
              ...
              <a href="mailto:contact@chayan.in" className="text-blue-600 hover:underline">contact@chayan.in</a>
